...
import { categories, NodeType, ChatbotNode, QuestionNode, LeafNode } from '../lib/questions';
import DataSpreadsheet from '@/components/spreadsheet'
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <DataSpreadsheet columns={aggregatedColumns} />
          </div>
        </div>
      </div>
    );
